...
ShellPatch::ShellPatch(int ingfsi, int fngfsi, const char *filename, int Symmetry, int myranki, monitor *ErrorMonitor) : ingfs(ingfsi), fngfs(fngfsi), myrank(myranki), PatL(0)
{
  int shapei[dim];
  double Rrangei[2];
